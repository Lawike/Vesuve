...
//------------------------------------------------------------------------------------------------
Texture::Texture(VkPhysicalDevice physicalDevice, VkDevice device, int width, int height, int channels, stbi_uc* pixels, VkCommandPool commandPool, VkQueue graphicsQueue) {
